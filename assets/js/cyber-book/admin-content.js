...
function togglePropertyInputType(){
    ...
    $parent.find(".nice-select").toggle();
}
function addBook(e){
    e.preventDefault();
    ...
    if($languageId.next().is(":visible") && $languageId.val() == "0"){
    ...
    if($authorId.next().is(":visible") && $authorId.val() == "0"){
    ...
    if($publisherId.next().is(":visible") && $publisherId.val() == "0"){
    ...
    if($backTypeId.next().is(":visible") && $backTypeId.val() == "0"){
